        ...
        <div className="pop-up-background">
            <div className="pop-up-container h-4/6 w-5/6 lg:w-4/6 p-0 flex flex-row">
                ...
                <section className="flex flex-col justify-center items-center p-5 font-kulim bg-main-cream">
                    ...
                    <h3 className="text-3xl font-medium font-source mt-16 mb-2">Free Merchandise!</h3>
                    <p className="my-3 text-center px-4">
                    ...
                    <>  
                        <input 
                            ...
                            className="form-input p-3 my-5 max-w-96 border-main-grey-100"
