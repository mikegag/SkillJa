...
urlpatterns = [
    ...
    path('email/order_confirmation/', views.order_confirmation_email, name='order_confirmation_email'),
    ...
    path('chat/create_transaction_notification/', views.create_transaction_notification, name='create_transaction_notification'),
